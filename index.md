...
venue: "University of New Mexico - Main"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
...
instructor: ["Margo Gustina", "Danielle Maurici-Pollack"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
